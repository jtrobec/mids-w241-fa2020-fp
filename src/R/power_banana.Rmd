...
Statistical power for weight is 0.51, which is not small although our sample size is small.
...
From the regression, treatment effect is 1.973g with a p-value of 0.158, which is not statistically significant. When we calculated cohen's d, it's 0.346.
...
From the regression treatment estimate is -0.04 with a p-value of 0.019, which is statistically significant. When we calculated cohen's d, it's 0.856. We can say it's practically significant.
